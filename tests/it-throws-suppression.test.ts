...
describe('@it-throws comprehensive suppression', () => {
...
14| }`;
  ...
  it('should work with assignment calls that previously had issues', () => {
    const code = stripLineNumbers`
1 | /**
...
9 | 
10| // @it-throws
11| export function processUserWithSuppression(userId: string, token: string) {
12|   try {
...
32| class DatabaseError extends Error {}`;
  ...
  it.skip('should handle multiple @it-throws functions independently', () => {
    const code = stripLineNumbers`
1 | function helper() {
...
4 | 
5 | // @it-throws
6 | function suppressedA() {
7 |   helper(); // Should be suppressed
8 | }
9 | 
10| // @it-throws  
11| function suppressedB() {
12|   helper(); // Should be suppressed
13| }
14| 
15| function notSuppressed() {
16|   helper(); // Should NOT be suppressed
17| }`;

    const diagnostics = analyzeCode(code);

    expectExactDiagnostics(diagnostics, {
      "L1": "Function helper may throw: {Error}",
      "L2": "Throw statement.",
      "L15": "Function notSuppressed may throw: {Error}",
      "L16": "Function call may throw: {Error}."
    });
  });

  it('should work with arrow functions and different syntax patterns', () => {
    const code = stripLineNumbers`
1 | const throwsError = () => {
...
4 | 
5 | // @it-throws
6 | const suppressedArrow = () => {
7 |   throwsError(); // Should be suppressed
8 |   throw new Error("suppressed"); // Should be suppressed
9 | };
10| 
11| const normalArrow = () => {
12|   throwsError(); // Should NOT be suppressed
13|   throw new Error("not suppressed"); // Should NOT be suppressed
14| };`;
